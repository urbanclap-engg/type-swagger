import {AddOrUpdateScheduledActionsResponse, UpdateScalingPoliciesRequest} from './platform';

interface AddProfilePhotoInput {
    entityId?: string;
    entityType?: string;
    faceProfileUrl?: UpdateScalingPoliciesRequest;
}

interface AddProfilePhotoOutput {
    success?: AddOrUpdateScheduledActionsResponse;
    message?: string;
}
